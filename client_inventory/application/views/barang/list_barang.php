			...
			<div class="card-body">
				...
				<div class="row">
					...
					<div class="col-md-3">
						...
						<input type="text" class="form-control form-input-cari" name="cari_desk" id="cari_desk">
					</div>
					<div class="col-md-3">
						<label>Maksimal Stok</label><br>
						<input type="number" class="form-control form-input-cari" name="cari_stok" id="cari_stok">
					</div>
					<div class="col-md-3">
						<br>
						<button id="btn-cari" class="btn btn-info">Cari Barang</button>
					</div>
				</div>
				<hr>
